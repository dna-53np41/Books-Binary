...
<form action="" class="search-form">
    ...
    <main class="cart-page" style="margin-top:3%">
        <h1>Your Cart</h1>
        
        <table class="table text-grey-darkest table-bordered table-striped table-hover text-center">
             <thead >
                <tr>
                    <th><h3>image</h3></th>
                    <th><h3>name </h3></th>
                ...
                <tbody>
                <?php foreach($relate as $c){?>
                <tr>
                     <td><img src="./images/<?php echo $c['3']?>" alt="" width="100px" height="130px"></td>
                     <td ><h2 class="mt-5"><?php echo $c['4']?></h2></td>
                     <td ><h2 class="mt-5">৳ <?php echo $c['5']?></h2></td>
                </tr>
        ...
        <a href="all.php" id="addmore-btn" >Add Books</a>
        <a href="delete.php?userid=<?php echo $user_id ?>" id="checkout-btn">Checkout</a>
